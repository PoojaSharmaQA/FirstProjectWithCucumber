...
import com.visionit.automation1.core.WebDriverFactory1;
import com.visionit.automation1.pageobjects.*;
...
public class StepDefs1 {
    ...
    //***********************Logger Init*************************************
    //***********************************************************************
    private static final Logger logger = LogManager.getLogger(StepDefs1.class);
    ...
    HomePageObjects1 homePageObjects;
    SignInPageObjects1 signInPageObjects;
    SearchPageObjects1 searchPageObjects;
    ProductDescriptionPageObjects1 productDescriptionPageObjects;
    ...
    public void setUp(Scenario scn) throws Exception {
        ...
        driver = WebDriverFactory1.getWebDriverForBrowser(browserName);
        logger.info("Browser invoked.");

        //Init Page Object Model Objects
        cmnPageObjects = new CommonPageObjects(driver);
        homePageObjects = new HomePageObjects1(driver);
        signInPageObjects = new SignInPageObjects1(driver);
        searchPageObjects = new SearchPageObjects1(driver);
        productDescriptionPageObjects = new ProductDescriptionPageObjects1(driver);
    }
  ...
  //1. Screen shot capturing is a important part of test cases failure investigation.
    ...
    public void user_navigated_to_the_home_application_url() {
        WebDriverFactory1.navigateToTheUrl(base_url);
    ...
    public void product_description_is_displayed_in_new_tab() {
        WebDriverFactory1.switchBrowserToTab();
