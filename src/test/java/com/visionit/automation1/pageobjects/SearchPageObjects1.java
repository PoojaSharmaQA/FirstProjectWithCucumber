...
import com.visionit.automation1.pageobjects.SearchPageObjects1;

import java.util.List;

public class SearchPageObjects1 {
	private static final Logger logger = LogManager.getLogger(SearchPageObjects1.class);
    ...
    public SearchPageObjects1(WebDriver driver){
        this.driver = driver;
    }
